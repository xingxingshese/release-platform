# 011-kubernetes-deployment · Kubernetes 部署验证

> DeploymentAdapter 抽象 + KubernetesAdapter(K8sGateway 端口隔离)、多 Pod 成功条件评估(ADR-006)、ReleaseDeploymentNode 逐节点记录、HealthCheckConfig/VersionCheckConfig 执行器、ReleaseSuccessEvaluator 最终判定。
